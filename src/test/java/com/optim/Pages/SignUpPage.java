...
public class SignUpPage
{
    ...
    public void clickOn_accountInformation_Mr_RadioButton()
    {
        try
        {
            wait.until(ExpectedConditions.elementToBeClickable(accountInformation_Mr_RadioButton)).click();
        } catch (Exception e)
        {
            e.printStackTrace();
        }
    ...
    public void clickOn_accountInformation_Mrs_RadioButton()
    {
        try
        {
            wait.until(ExpectedConditions.elementToBeClickable(accountInformation_Mrs_RadioButton)).click();
        } catch (Exception e)
        {
            e.printStackTrace();
        }
    ...
    public void fillDataIn_accountInformation_Name_TextBox(String name)
    {
        try
        {
            wait.until(ExpectedConditions.visibilityOfElementLocated(accountInformation_Name_TextBox)).sendKeys(name);
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public void fillDataIn_accountInformation_Email_TextBox(String email)
    {
        try
        {
            wait.until(ExpectedConditions.visibilityOfElementLocated(accountInformation_Email_TextBox)).sendKeys(email);
        }
        catch(Exception e)
        {
            e.printStackTrace();
    ...
    public void fillDataIn_accountInformation_Password_TextBox(String password)
    {
        try
        {
            wait.until(ExpectedConditions.visibilityOfElementLocated(accountInformation_Password_TextBox)).sendKeys(password);
        }
        catch(Exception e)
        {
            throw new RuntimeException("Unable To Fill Data In Password Text Box : " + password, e);
        }
    }
    ...
    public void selectDOB(String dob)
    {
        ...
        {  
            ...
            Select days_DropDown = new Select(driver.findElement(accountInformation_DOB_Days_DropDown) );
            days_DropDown.selectByVisibleText(days); 
            Thread.sleep(5000);
            Select months_DropDown = new Select(driver.findElement(accountInformation_DOB_Months_DropDown));
            days_DropDown.selectByIndex(Integer.parseInt(months));
            Thread.sleep(5000);
            Select years_DropDown = new Select(driver.findElement(accountInformation_DOB_Years_DropDown));
            days_DropDown.selectByVisibleText(years);
            Thread.sleep(5000);
        }
        catch(Exception e)
        {
            throw new RuntimeException("DOB selection failed for: " + dob, e);
        }
    }
}
